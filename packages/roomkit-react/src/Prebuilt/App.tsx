...
import ConnectionNotification from "./components/Connection/ConnectionNotification";
// @ts-ignore: No implicit Any
...
import { HMSPrebuiltContext, UpdateRoomPayload } from "./AppContext";
import {
  AppStateContext,
  PrebuiltStates,
  useAppStateManager,
...
>(
  (
    ...
    useEffect(() => {
      ...
      // Add event listener for window reload/close
