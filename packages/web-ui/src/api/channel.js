...
export const createChannel = async (data) =>
  await authFetch({
    url: `${apiBaseUrl}/channel/resources/createChannel`,
    method: "POST",
    body: data,
  });

export const getUserData = async () =>
  await authFetch({ url: `${apiBaseUrl}/channel/getUser` });
...
export const getChatToken = async (chatRoomArn, isModerator, signal) =>
  await authFetch({
    url: `${apiBaseUrl}/channel/chatToken/create`,
    method: "POST",
    body: { chatRoomArn, isModerator },
  });

export const sendChatEvent = async (eventPayload) =>
  await authFetch({
    url: `${apiBaseUrl}/channel/event/send`,
    method: "POST",
    body: { ...eventPayload },
  });
...
export const sendStreamAction = async (metadataString, sessionId) =>
  await authFetch({
    method: 'POST',
    url: `${apiBaseUrl}/channel/actions/send`,
    body: { metadata: metadataString, sessionId }
  });
