...
const insetHeightPx = 100;
const insetMaxWidthPx = 133;
...
export const InsetTile = ({
  ...
  let aspectRatio = desktopAspectRatio;
  ...
  // Force landscape mode or adjust to landscape if necessary
  if ((forceLandscape || isLandscape) && width > insetMaxWidthPx) {
    width = 240;
