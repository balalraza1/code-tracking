# Shadcn UI with Create React App
...
7. Let’s add our first Shadcn/ui component. Run the following command: `npx shadcn-ui add button` and edit the path command to be `./src/shadcn/components/ui`
