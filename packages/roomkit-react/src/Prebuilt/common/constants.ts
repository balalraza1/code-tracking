...
export enum QuizState {
  ...
  END_QUIZ = "END_QUIZ",
  RELAUNCH_QUIZ = "RELAUNCH_QUIZ",
}

export interface QuizData {
  room_id: string;
  room_type: string;
  predefined_room_id: string;
}

export const TEACHER_ROLE_NAME = "teacher";
export const STUDENT_ROLE_NAME = "attendees";

export const TRAINER_JOINED_ROOM = "TRAINER_JOINED_ROOM";
export const TRAINER_LEFT_ROOM = "TRAINER_LEFT_ROOM";
export const TRAINER_NOT_PRESENT = "TRAINER_NOT_PRESENT";
export const TRAINER_ALREADY_PRESENT = "TRAINER_ALREADY_PRESENT";

export const CREATE_BREAKOUT_ROOM = "CREATE_BREAKOUT_ROOM";
export const BREAKOUT_ROOM_CODE = "BREAKOUT_ROOM_CODE";
