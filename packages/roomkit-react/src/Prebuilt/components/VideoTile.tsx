...
import { APP_DATA, STUDENT_ROLE_NAME, UI_SETTINGS } from "../common/constants";
    ...
    >
      {peerName !== undefined ? (
        ...
        >
          ...
          {(isMouseHovered && localPeerRoleName !== STUDENT_ROLE_NAME) ||
          (isDragabble && navigator.maxTouchPoints > 0) ? (
            <TileMenu
              peerID={peerId}
              audioTrackID={audioTrack?.id || ""}
              videoTrackID={track?.id || ""}
