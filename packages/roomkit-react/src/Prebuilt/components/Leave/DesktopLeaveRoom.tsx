            ...
            <Dropdown.Portal container={container}>
              ...
              >
                {breakoutRoomCode !== null &&
                  breakoutRoomCode !== parentRoomCode && (
                    <Dropdown.Item
                      css={{
                        bg: "$surface_dim",
                      ...
                      data-testid="breakout_room_leave_btn"
                    >
                      <LeaveCard
                        title="Leave Break Room"
                        subtitle="Break room will be closed and you will be directed to the main seassion."
                        bg=""
                        ...
                        onClick={async () => {
                          leaveBreakoutRoom && (await leaveBreakoutRoom());
                        }}
                        css={{ p: "$8 $4" }}
                      />
                    </Dropdown.Item>
